...
def build_ajax(project_name, template_name, html_strings, html_inserts, myrelations):
    ...
    print "The string html_filenames contains"
    ...
    for html_filename in html_filenames:
        ...
        if html_filename.endswith(".html"):
            ...
            if html_filename == "browse":
                # do not recreate if already exits...
                if os.path.exists( os.path.join(html_dir + html_filename) ):
                    continue
                else:
                    ...
                    #continue # i don't think we need this
