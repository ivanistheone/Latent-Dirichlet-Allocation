...
#    """
#    Implements online VB for LDA as described in (Hoffman et al. 2010). Most of
#    the code is directly copy&pasted from his `olda` package and is here for
#    comparison (to be digested later).
#    """
#
